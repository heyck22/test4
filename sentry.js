...
var Sentry = function(n) {
    ...
    (i = n.Severity || (n.Severity = {})).Fatal = "fatal",
    i.Error = "error",
    i.Warning = "warning",
    i.Log = "log",
    i.Info = "info",
    ...
    (o = n.Status || (n.Status = {})).Unknown = "unknown",
    o.Skipped = "skipped",
    o.Success = "success",
    ...
    function j(n) {
        ...
        ["debug", "info", "warn", "error", "log", "assert"].forEach(function(n) {
            n in t.console && r[n].__sentry__ && (e[n] = r[n].__sentry_wrapped__,
    ...
    function C(n, t, r, e) {
        ...
        if (e.memoize(t))
            return "[Circular ~]";
        for (var c in o)
            Object.prototype.hasOwnProperty.call(o, c) && (u[c] = C(c, o[c], r - 1, e));
    ...
    var L, M = function() {
        ...
        n.prototype.add = function(n) {
            var t = this;
            return this.isReady() ? (-1 === this.h.indexOf(n) && this.h.push(n),
            n.then(function() {
                return t.remove(n)
            }).catch(function() {
    ...
    var W = function() {
        function n(n) {
            ...
            ,
            this.m = function(n, r) {
                t.l === L.PENDING && (m(n) ? n.then(t.p, t.g) : (t.j = n,
                t.l = r,
                t._()))
            }
            ,
      ...
      , X = function() {
        ...
        n.prototype.setTag = function(n, t) {
            var r;
            return this.L = u({}, this.L, ((r = {})[n] = A(t),
            r)),
            this.F(),
            this
        }
        ...
        n.prototype.setExtra = function(n, t) {
            var r;
            return this.M = u({}, this.M, ((r = {})[n] = A(t),
            r)),
            this.F(),
            this
        }
        ...
        n.prototype.addBreadcrumb = function(n, t) {
            ...
            return this.C = void 0 !== t && t >= 0 ? s(this.C, [A(e)]).slice(-t) : s(this.C, [A(e)]),
            this.F(),
            this
        }
        ,
        ...
        n.prototype.applyToEvent = function(n, t) {
            return this.M && Object.keys(this.M).length && (n.extra = u({}, this.M, n.extra)),
            this.L && Object.keys(this.L).length && (n.tags = u({}, this.L, n.tags)),
            this.A && Object.keys(this.A).length && (n.user = u({}, this.A, n.user)),
            this.U && Object.keys(this.U).length && (n.contexts = u({}, this.U, n.contexts)),
            this.q && (n.level = this.q),
            this.H && (n.transaction = this.H),
            this.W && (n.contexts = n.contexts || {},
            n.contexts.trace = this.W),
            this.B(n),
            n.breadcrumbs = s(n.breadcrumbs || [], this.C),
    ...
    function fn(n) {
        ...
        return function(n) {
            ...
            t[n.name] = n,
            function(n) {
                -1 === an.indexOf(n.name) && (n.setupOnce(z, Y),
                an.push(n.name),
    ...
    var hn, ln = function() {
        ...
        return n.prototype.captureException = function(n, t, r) {
            var e = this
              , i = t && t.event_id;
            return this.rn = !0,
            this.cn().eventFromException(n, t).then(function(n) {
                return e.sn(n, t, r)
            }).then(function(n) {
                i = n && n.event_id,
                e.rn = !1
        ...
        n.prototype.captureMessage = function(n, t, r, e) {
            var i = this
              , o = r && r.event_id;
            return this.rn = !0,
            (d(n) ? this.cn().eventFromMessage("" + n, t, r) : this.cn().eventFromException(n, r)).then(function(n) {
                return i.sn(n, r, e)
            }).then(function(n) {
                o = n && n.event_id,
                i.rn = !1
        ...
        n.prototype.flush = function(n) {
            ...
            return this.an(n).then(function(r) {
                return t.fn && clearInterval(t.fn),
                t.cn().getTransport().close(n).then(function(n) {
                    return r && n
                })
            })
        }
        ...
        n.prototype.an = function(n) {
            ...
            return new Promise(function(r) {
                var e = 0;
                t.fn && clearInterval(t.fn),
                t.fn = setInterval(function() {
                    t.rn ? (e += 1,
                    n && e >= n && r(!1)) : r(!0)
                }, 1)
            }
        ...
        n.prototype.ln = function(n, t, r) {
            var e = this.getOptions()
              ...
              , a = void 0 === s ? 250 : s
              , f = u({}, n);
            void 0 === f.environment && void 0 !== i && (f.environment = i),
            void 0 === f.release && void 0 !== o && (f.release = o),
            void 0 === f.dist && void 0 !== c && (f.dist = c),
            f.message && (f.message = U(f.message, a));
            var h = f.exception && f.exception.values && f.exception.values[0];
            h && h.value && (h.value = U(h.value, a));
            var l = f.request;
            l && l.url && (l.url = U(l.url, a)),
            void 0 === f.event_id && (f.event_id = w()),
            this.vn(f.sdk);
            var v = W.resolve(f);
            return t && (v = t.applyToEvent(f, r)),
            v
        }
        ,
        ...
        function n(n) {
            this.in = n,
            this.in.dsn || k.warn("No DSN provided, backend will not do anything."),
            this.pn = this.mn()
        }
    ...
    var pn = function() {
      ...
      , yn = function() {
        ...
        n.prototype.bn = function(n, t) {
            ...
            !0) : this.gn(n, t) ? (k.warn("Event dropped due to being matched by `ignoreErrors` option.\nEvent: " + E(n)),
            !0) : this.En(n, t) ? (k.warn("Event dropped due to being matched by `blacklistUrls` option.\nEvent: " + E(n) + ".\nUrl: " + this.jn(n)),
            !0) : !this.xn(n, t) && (k.warn("Event dropped due to not being matched by `whitelistUrls` option.\nEvent: " + E(n) + ".\nUrl: " + this.jn(n)),
            !0)
        }
        ,
        ...
        n.prototype.gn = function(n, t) {
            return void 0 === t && (t = {}),
            !(!t.ignoreErrors || !t.ignoreErrors.length) && this._n(n).some(function(n) {
        ...
        n.prototype.jn = function(n) {
            try {
                ...
                return k.error("Cannot extract url for event " + E(n)),
                null
            }
        }
        ,
    ...
    gn.Sn = function() {
        ...
        function s(n) {
            ...
            r.message || (r.message = JSON.stringify(A(t))),
            o(r, !0, t)
        }
        function a() {
            var n = i
        ...
        function n(n) {
            ...
            for (var t, r, e, i = /^\s*at (?:(.*?) ?\()?((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|[a-z]:|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, o = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension).*?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js))(?::(\d+))?(?::(\d+))?\s*$/i, u = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, c = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, s = /\((\S*)(?::(\d+))(?::(\d+))\)/, a = n.stack.split("\n"), f = [], h = /^(.*) is undefined$/.exec(n.message), l = 0, v = a.length; l < v; ++l) {
                if (r = i.exec(a[l])) {
                    ...
                    r[2] && 0 === r[2].indexOf("eval") && (t = s.exec(r[2])) && (r[2] = t[1],
                    r[3] = t[2],
                    r[4] = t[3]),
                    e = {
                        url: r[2],
                    ...
                    if (!(r = o.exec(a[l])))
                        continue;
                    r[3] && r[3].indexOf(" > eval") > -1 && (t = c.exec(r[3])) ? (r[1] = r[1] || "eval",
                    r[3] = t[1],
                    r[4] = t[2],
                    r[5] = "") : 0 !== l || r[5] || void 0 === n.columnNumber || (f[0].column = n.columnNumber + 1),
                    e = {
                        url: r[3],
                        func: r[1] || En,
                        args: r[2] ? r[2].split(",") : [],
        ...
        function t(n, t, r, e) {
            ...
            if (i.url && i.line) {
                ...
                n.stack.length > 0 && n.stack[0].url === i.url) {
                    if (n.stack[0].line === i.line)
                        return !1;
                    if (!n.stack[0].line && n.stack[0].func === i.func)
                        return n.stack[0].line = i.line,
                        n.stack[0].context = i.context,
                        !1
                }
                return n.stack.unshift(i),
                n.partial = !0,
                !0
            }
            return n.incomplete = !0,
            !1
        }
        function r(n, e) {
        ...
        function e(t, e) {
                ...
                if (i = function(n) {
                    ...
                    if (t) {
                        for (var r, e = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i, i = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^\)]+))\((.*)\))? in (.*):\s*$/i, o = t.split("\n"), u = [], c = 0; c < o.length; c += 2) {
                            ...
                            s && (!s.func && s.line && (s.func = En),
                            s.line && (s.context = null),
                            s.context || (s.context = [o[c + 1]]),
                            u.push(s))
                        }
                        return u.length ? {
                            mode: "stacktrace",
            ...
            try {
                if (i = function(n) {
                    ...
                    if (t.length < 4)
                        return null;
                    var r, e = /^\s*Line (\d+) of linked script ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i, i = /^\s*Line (\d+) of inline#(\d+) script in ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i, o = /^\s*Line (\d+) of function script\s*$/i, u = [], c = wn && wn.document && wn.document.getElementsByTagName("script"), s = [];
                    for (var a in c)
                        xn(c, a) && !c[a].src && s.push(c[a]);
    ...
    var Cn, An, Ln = function() {
        function n(n) {
            this.options = n,
            this.h = new M(30),
            this.url = new sn(this.options.dsn).getStoreEndpointWithUrlEncodedAuth()
        }
        ...
        e.prototype.mn = function() {
            if (!this.in.dsn)
                return t.prototype.mn.call(this);
        ...
        ,
        e
    }(dn), qn = "sentry.javascript.browser", Hn = function(n) {
        function t(t) {
            return void 0 === t && (t = {}),
            n.call(this, $n, t) || this
        }
        return r(t, n),
                ...
                if (this.hn()) {
                    ...
                    if (n.eventId)
                        if (r) {
                            ...
                            e.async = !0,
                            e.src = new sn(r).getReportDialogEndpoint(n),
    ...
    function Jn(n, t, r) {
            ...
            try {
                ...
                on(function(r) {
                    r.addEventProcessor(function(n) {
                        var r = u({}, n);
                        return t.mechanism && x(r, void 0, void 0, t.mechanism),
                        r.extra = u({}, r.extra, {
                            arguments: A(e, 3)
                        }),
                        r
        ...
        try {
            for (var e in n)
                Object.prototype.hasOwnProperty.call(n, e) && (sentryWrapped[e] = n[e])
        } catch (n) {}
    ...
    function zn() {
        return function(n) {
            ...
            var r = t && t.tagName;
            r && ("INPUT" === r || "TEXTAREA" === r || t.isContentEditable) && (Cn || Gn("input")(n),
            clearTimeout(Cn),
    ...
    function Vn(n) {
        for (var t, r = n, e = [], i = 0, o = 0, u = " > ".length; r && i++ < 5 && !("html" === (t = Kn(r)) || i > 1 && o + e.length * u + t.length >= 80); )
            e.push(t),
            o += t.length,
            r = r.parentNode;
    ...
    function Kn(n) {
        ...
        if (!n || !n.tagName)
            return "";
        if (u.push(n.tagName.toLowerCase()),
        n.id && u.push("#" + n.id),
        (t = n.className) && v(t))
            for (r = t.split(/\s+/),
            o = 0; o < r.length; o++)
    ...
    var Zn = function() {
        ...
        return n.prototype.setupOnce = function() {
            ...
            this.in.onerror && (k.log("Global Handler attached: onerror"),
            On()),
            this.in.onunhandledrejection && (k.log("Global Handler attached: onunhandledrejection"),
            kn())
        }
        ,
      ...
      , Qn = function() {
        ...
        n.prototype.setupOnce = function() {
            this.Mn = this.Mn;
            var n = b();
            R(n, "setTimeout", this.Un.bind(this)),
            R(n, "setInterval", this.Un.bind(this)),
            R(n, "requestAnimationFrame", this.Fn.bind(this)),
    ...
    var nt, tt = b(), rt = function() {
            ...
            "console"in tt && ["debug", "info", "warn", "error", "log", "assert"].forEach(function(r) {
                r in tt.console && R(tt.console, r, function(e) {
                    return function() {
                        ...
                        "assert" === r && !1 === i[0] && (u.message = "Assertion failed: " + (F(i.slice(1), " ") || "console.assert"),
                        u.data.extra.arguments = A(i.slice(1), 3)),
                        t.addBreadcrumb(u, {
                            input: i,
                            level: r
                        }),
        ...
        t.prototype.qn = function() {
            "document"in tt && (tt.document.addEventListener("click", Gn("click"), !1),
            tt.document.addEventListener("keypress", zn(), !1),
            ["EventTarget", "Node"].forEach(function(n) {
                ...
                t && t.hasOwnProperty && t.hasOwnProperty("addEventListener") && (R(t, "addEventListener", function(n) {
                    return function(t, r, e) {
                        ...
                        "keypress" === t && R(r, "handleEvent", zn())) : ("click" === t && Gn("click", !0)(this),
                        "keypress" === t && zn()(this)),
                        n.call(this, t, r, e)
                    }
                }),
            ...
            q() && -1 !== b().fetch.toString().indexOf("native") && R(tt, "fetch", function(r) {
                return function() {
                    for (var e = [], i = 0; i < arguments.length; i++)
                        e[i] = arguments[i];
                    var o, u = e[0], c = "GET";
                    "string" == typeof u ? o = u : "Request"in tt && u instanceof Request ? (o = u.url,
                    u.method && (c = u.method)) : o = String(u),
                    ...
                    if (a) {
                        ...
                        if (f && o.includes(f))
                            return "POST" === c && e[1] && e[1].body && et(e[1].body),
                            r.apply(tt, e)
                    }
                    var h = {
                        method: c,
        ...
        t.prototype.Wn = function() {
            ...
            !i && o) {
                ...
                ,
                R(tt.history, "pushState", s),
                R(tt.history, "replaceState", s)
            }
            function s(n) {
                return function() {
                    for (var t = [], r = 0; r < arguments.length; r++)
            ...
            if ("XMLHttpRequest"in tt) {
                ...
                R(n, "send", function(n) {
                    return function() {
                        ...
                        return i.__sentry_own_request__ && et(r[0]),
    ...
    var it = "cause"
      ...
      , ut = function() {
        ...
        ,
        n.prototype.Xn = function(n, t) {
            if (!(n.exception && n.exception.values && t && t.originalException instanceof Error))
                return n;
            var r = this.Gn(t.originalException, this.Jn);
            return n.exception.values = s(r, n.exception.values),
            n
        }
        ,
        n.prototype.Gn = function(n, t, r) {
            if (void 0 === r && (r = []),
            !(n[t]instanceof Error) || r.length + 1 >= this.s)
                return r;
            var e = Dn(Tn(n[t]));
        ...
        return n.prototype.setupOnce = function() {
            z(function(t) {
                if (Y().getIntegration(n)) {
                    if (!ct.navigator || !ct.location)
                        return t;
                    var r = t.request || {};
                    return r.url = r.url || ct.location.href,
                    r.headers = r.headers || {},
                    r.headers["User-Agent"] = ct.navigator.userAgent,
                    u({}, t, {
                        request: r
                    })
                }
    ...
    ,
    n.getCurrentHub = Y,
    n.getHubFromCarrier = tn,
    n.init = function(n) {
        void 0 === n && (n = {}),
        void 0 === n.defaultIntegrations && (n.defaultIntegrations = ft),
        function(n, t) {
            !0 === t.debug && k.enable(),
            Y().bindClient(new n(t))
        }(Hn, n)
    }
    ,
    ...
    n.showReportDialog = function(n) {
        void 0 === n && (n = {}),
        n.eventId || (n.eventId = Y().lastEventId());
        var t = Y().getClient();
